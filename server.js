...
if (databaseUrl && databaseUrl.includes('sslmode=')) {
    try {
        ...
        console.log('Removed sslmode parameter from DATABASE_URL to ensure ssl settings are honored');
    } catch (e) {
        console.warn('Failed to parse DATABASE_URL, using original:', e.message);
